...
#    Updated: 2018/12/17 15:36:50 by cseguier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_capitalize.c ft_foreach.c ft_isalnum.c \
	  ...
	  ft_putnbr_fd.c ft_putstr.c ft_putstr_fd.c ft_quicksort.c ft_sqrt.c \
	  ft_strcat.c ft_strccpy.c ft_strchr.c ft_strclr.c ft_strcmp.c \
