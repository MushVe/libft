...
#    Updated: 2018/11/30 13:38:43 by cseguier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRC = ft_atoi.c ft_bzero.c ft_foreach.c \
...
ft_putstr.c ft_putstr_fd.c ft_quicksort.c ft_sqrt.c ft_strcat.c ft_strchr.c \
...
OBJ = ft_atoi.o ft_bzero.o ft_foreach.o \
ft_isalnum.o ft_isalpha.o ft_isascii.o \
ft_isdigit.o ft_isprint.o ft_itoa.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o \
...
ft_putstr.o ft_putstr_fd.o ft_quicksort.o ft_sqrt.o ft_strcat.o ft_strchr.o \
...
ft_strnstr.o ft_strrchr.o ft_strrev.o ft_strsplit.o ft_strstr.o ft_strsub.o \
